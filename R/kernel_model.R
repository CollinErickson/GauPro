#' Class providing object with methods for fitting a GP model using kernels
#'
#' @docType class
...
#'   }
GauPro_kernel_model <- R6::R6Class(classname = "GauPro_kernel_model",
  public = list(
    X = NULL,
    Z = NULL,
    N = NULL,
    ...
    initialize = function(X, Z, kernel, verbose=0, useC=F, useGrad=T,
                          parallel=T,

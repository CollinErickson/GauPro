...
gp$cool1Dplot()
numDeriv::grad(func = function(x)gp$deviance(params=x[1:3], nuglog=x[4]), x=c(2,9, .2, -4))
gp$deviance_grad(params = c(2,9, .2), nug.update=T, nuglog=-4)
numDeriv::grad(func = function(x)gp$deviance(params=x[1:3], nuglog=x[4]), x=c(gp$kernel$beta, gp$kernel$alpha, gp$kernel$logs2, log(gp$nug,10)))
gp$deviance_grad(params = c(gp$kernel$beta, gp$kernel$alpha, gp$kernel$logs2), nug.update=T, nuglog=log(gp$nug,10))

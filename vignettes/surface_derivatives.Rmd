...
The other vignette, *Introduction to GPs*, has derivatives of the deviance (likelihood) with respect to the parameters.
...
$$ \text{Var}\big[ \frac{\hat{y}(x + \delta e_i) - \hat{y}(x)}{\delta} \big] = \frac{1}{\delta^2}\text{Var}\big[ \hat{y}(x + \delta e_i) - \hat{y}(x) \big]$$
$$=\frac{1}{\delta^2}\big( \text{Var}\big[ \hat{y}(x + \delta e_i)  \big] + \text{Var}\big[ \hat{y}(x) \big] + -2 \text{Cov}\big[ \hat{y}(x + \delta e_i), \hat{y}(x) \big] \big)$$
$$ \text{Var}\big[ \hat{y}(x + \delta e_i) |Y \big] = \Sigma_{11} - \Sigma_{1Y} \Sigma_{YY}^{-1} \Sigma_{Y1}  $$
$$ \text{Var}\big[ \hat{y}(x) |Y \big] = \Sigma_{22} - \Sigma_{2Y} \Sigma_{YY}^{-1} \Sigma_{Y2}  $$
$$ \text{Cov}\big[ \hat{y}(x + \delta e_i), \hat{y}(x)|Y \big] =  \text{Cov}\big[ \hat{y}(x + \delta e_i), \hat{y}(x) \big] - \text{Cov}\big[ \hat{y}(x + \delta e_i), Y \big] \Sigma_{YY}^{-1} \text{Cov}\big[ Y, \hat{y}(x) \big] $$
...
$$ \text{Var}[(1,-1)^T (z_1, z_2)] = (1,-1)^T \text{Cov}((z_1, z_2)) (1,-1)$$
...
\lim_{\delta \rightarrow 0}\text{Var}( \frac{1}{\delta} [1, -1]^T Y_u | Y_X)  \\
= \lim_{\delta \rightarrow 0} \frac{1}{\delta^2} [1, -1]^T \text{Cov}(Y_u | Y_X) [1, -1] \\
...
#### Alternate, cleaner, correcter derivation?
